...
public class CronometroActivity extends AppCompatActivity {
        ...
        btnStop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (btn.getText().toString().compareTo("Stop") == 0) {
                    ...
                    Intent intent=new Intent(CronometroActivity.this,TiempoListoActivity.class);
                    //variable=String.valueOf(dato);
                    intent.putExtra("variable2",dato);
     ...
     */
    class TareaCronometro extends AsyncTask<Void, String, String> {
        ...
        public void parar() {
            ...
            btnStop.setText("Tiempo detenido");
        }
